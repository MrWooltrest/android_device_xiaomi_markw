...
# Init
$(call soong_config_set,libinit,vendor_init_lib,//$(LOCAL_PATH):libinit_markw)

# Input
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/keylayout/atmel-maxtouch.kl:$(TARGET_COPY_OUT_VENDOR)/usr/keylayout/atmel-maxtouch.kl \
...
$(call soong_config_set,qtipower,tap_to_wake_node,/proc/sys/dev/xiaomi_touchscreen/enable_dt2w)
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/wifi/WCNSS_cfg.dat:$(TARGET_COPY_OUT_VENDOR)/firmware/wlan/prima/wlan/prima/WCNSS_cfg.dat \
...
$(call soong_config_set,wcnss_service,wcnss_qmi_include_dir,$(LOCAL_PATH)/configs/wifi/include)
